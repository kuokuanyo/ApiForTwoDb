...
//更新資料表
//關聯表
func (u UserRepository) UpdateJoinData(MySqlDb *driver.MySqlDb, MsSqlDb *driver.MsSqlDb, peoples []models.People, events []models.Event, MysqlColName []string, MssqlColName []string) error {
	var err error
	...
	peoples, err = MySqlDb.MysqlQueryAllDataBySomeCol(peoples, MysqlColName)
	if err != nil {
		return err
	}
